package com.example.listadetareas_edit.Modelo;
...
public class Tarea {
    ...
    public String getCategoriaNombre(Context context) {
        String[] cat = new String[]{context.getString(R.string.cat_0), context.getString(R.string.cat_1), context.getString(R.string.cat_2), context.getString(R.string.cat_3), context.getString(R.string.cat_4), context.getString(R.string.cat_5)};
